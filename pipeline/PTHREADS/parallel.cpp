...
bitmap_image filter_blur(rgb_t **inImage, int height, int width, bitmap_image out)
{
...
int main()
{
    ...
    arguments[2] = 2;
    r3 = pthread_create(&threads[2], NULL, filter_black_white_task, (void *)&arguments[2]);

    arguments[3] = 3;
    r4 = pthread_create(&threads[3], NULL, filter_contrast_task, (void *)&arguments[3]);

    arguments[4] = 4;
    r5 = pthread_create(&threads[4], NULL, filter_sharpness_task, (void *)&arguments[4]);

    arguments[5] = 5;
    r6 = pthread_create(&threads[5], NULL, filter_blur_task, (void *)&arguments[5]);
